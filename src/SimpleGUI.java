...
public class SimpleGUI extends JFrame implements ActionListener, ItemListener, ChangeListener {
    ...
    private void init() {
        ...
        //setting up sliders to use ChangeListener interface and changePerformed method
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if(source instanceof JButton) {
            ...
            if (text.equals("Send")) {
                ...
                newWindow.add(hello);
                hello.setFont(new Font("Comic-sans", Font.ITALIC, 40));
                setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                newWindow.setSize(200, 200);
                newWindow.setLocation(100, 100);
            ...
            if(text.equals("About")){
                ...
                textField.equals("Open");
            }else if(text.equals("Save As")){
                textField.equals("Save As");
            }else if(text.equals("FAQ")){
                textField.equals("FAQ");
            }
        }
